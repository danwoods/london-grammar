if(typeof(SongkickWidget) === 'undefined') { SongkickWidget = {}; };

Widget = SongkickWidget.Widget = {
  ...
  getRequestInformation: function() {
    ...
    var regex = new RegExp("^https?://(www.staging.songkick.net|www.songkick.com)/(artists|users|venues)/([0-9a-zA-Z-\+\._]+|[0-9]+)$");
    ...
    if (match) {
      ...
      var response = { targetDomain: targetDomain,
                       stagingEnv: targetDomain == "widget.staging.songkick.net",
